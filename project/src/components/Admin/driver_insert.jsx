...
const driver_insert = () => {
  ...
  password:'',cpassword:'',contact:0,address:'',area:0,license:'',
  });
  ...
  function register(event){
    ...
    if(Object.entries(checkerr).length=== 0){
     axios.post("http://localhost:8800/drregister",{
      fname:values.fname,
      lname:values.lname,
    ...
    <div className="page-container">
        ...
        <div className="right">
          ...
          <div className="main-content">
            <div className="title">
              <p>Insert into Driver Table</p>
            </div>
            <div className="insert_body">
              <form onSubmit={register}>
              <div style={{color:'red',fontsize:'10px',textAlign:'center', marginTop:'5px'}}>{registerstatus} </div>
